...
export const fallbackBlogsData = [
  {
    slug: "understanding-core-web-vitals",
    title: "Understanding Core Web Vitals for Modern SEO",
    excerpt:
      "A deep dive into how Google's Core Web Vitals impact your search rankings and what you can do to optimize them.",
    category: "SEO",
    ...
    authorAvatar:
      "https://api.dicebear.com/7.x/initials/svg?seed=Anavya",
  ...
  },
  {
    ...
    excerpt:
      "Broken links can hurt your SEO and user experience. Learn how to identify and resolve them quickly.",
    ...
    authorAvatar:
      "https://api.dicebear.com/7.x/initials/svg?seed=AnavyaTech",
...
export async function seedBlogs() {
  ...
  await db.insert(blogs).values(fallbackBlogsData);
